...
class Menu(Entity):
    def __init__(self,**kwargs):
        ...
        ButtonList(button_dict={
            "Start": Func(print,"You click on Start button!"),
        ...
        # Button list
        ButtonList (button_dict={
            "Gameplay": Func(print,"You click on Gameplay help button!"),
            "Battle": Func(print,"You click on Battle help button!"),
            "Control": Func(print,"You click on Control help button!"),
